...
if (jjtc000) {
  ...
  final public JsonObjectBuilder CreateStatement(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) CreateStatement */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder CreateAnalysis(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) CreateAnalysis */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder DeclareAnalysis(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) DeclareAnalysis */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder AnalysisStatement(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) AnalysisStatement */
    ...
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FIELDNAME:{
        tempJB = UserDefinedFunction(tempJB);
jObject.add("ufn", tempJB.build());
        break;
        }
      case AWSM:
      case SELECT:{
        tempJB = AwsmDefinedFunction(tempJB);
jObject.add("nfn", tempJB.build());
        break;
        }
      default:
        jj_la1[9] = jj_gen;
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder FunctionParam(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) FunctionParam */
                                                              ASTFunctionParam jjtn000 = new ASTFunctionParam(JJTFUNCTIONPARAM);
                                                              boolean jjtc000 = true;
                                                              jjtree.openNodeScope(jjtn000);Token t; Token t2;Token t3; JsonArrayBuilder array  =Json.createArrayBuilder();JsonObjectBuilder tempJB = Json.createObjectBuilder();
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ALPHANUM:{
        t = jj_consume_token(ALPHANUM);
...
jjtree.closeNodeScope(jjtn000, true);
       jjtc000 = false;
jObject.add("param",array.build());{if ("" != null) return jObject;}
    } finally {
if (jjtc000) {
          jjtree.closeNodeScope(jjtn000, true);
        }
  ...
  final public JsonObjectBuilder AwsmDefinedFunction(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) JsonObjectBuilder */
...
jObject.add("input","cypher"); jObject.add("stmt", tempJB.build());
        ...
        case ALPHANUM:
        case FIELDNAME:{
          FunctionParam(tempJB);
jObject.add("input","function"); jObject.add("stmt", tempJB.build());
          break;
          }
        default:
          jj_la1[18] = jj_gen;
...
jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
System.out.println("xxxxxx");{if ("" != null) return jObject;}
        break;
        }
      default:
        jj_la1[19] = jj_gen;
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder UserDefinedFunction(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) UserDefinedFunction */
...
*
*/
  final public JsonObjectBuilder AwesomeSafeFunction(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) AwesomeSafeFunction */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder CreateView(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) CreateView */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder ProjectFunction(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) ProjectFunction */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder ReportAnalysis(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) ReportAnalysis */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder FunctionAnalysis(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) FunctionAnalysis */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder ExecuteSQLPP(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) ExecuteSQLPP */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder executeCypher(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) executeCypher */
...
if (jjtc000) {
  ...
  final public Token quetedStatement() throws ParseException {/*@bgen(jjtree) quetedStatement */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder FilterOperation(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) FilterOperation */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder AnnotateWithStoreOperation(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) AnnotateWithStoreOperation */
                                                                           ASTAnnotateWithStoreOperation jjtn000 = new ASTAnnotateWithStoreOperation(JJTANNOTATEWITHSTOREOPERATION);
                                                                           boolean jjtc000 = true;
                                                                           jjtree.openNodeScope(jjtn000);boolean withnessflag=false;  JsonObjectBuilder annotateInfo = Json.createObjectBuilder();
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder Cypher(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) Cypher */
                                                     ASTCypher jjtn000 = new ASTCypher(JJTCYPHER);
                                                     boolean jjtc000 = true;
                                                     jjtree.openNodeScope(jjtn000);Token a,b; JsonObjectBuilder tempJB = Json.createObjectBuilder(); Token q;JsonObjectBuilder tempAB = Json.createObjectBuilder(); JsonArrayBuilder path  =Json.createArrayBuilder();
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ALPHANUM:{
        a = jj_consume_token(ALPHANUM);
        b = jj_consume_token(GraphElementType);
        break;
        }
      case FBRACKETSTART:{
        jj_consume_token(FBRACKETSTART);
...
JsonObjectBuilder tempa = Json.createObjectBuilder(); tempa.add("name", a.image);JsonObjectBuilder tempb = Json.createObjectBuilder(); tempb.add("type", b.image); tempAB.add("0", tempa.build()) ; tempAB.add("1", tempb.build()) ;
      ...
      while (true) {
        ...
        case INPATH:
        case OUTPATH:{
JsonObjectBuilder tempJC = Json.createObjectBuilder();Token c, d, e, f, g, h;
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case INPATH:{
            jj_consume_token(INPATH);
tempAB.add( a.image, "in" );
            break;
            }
          case OUTPATH:{
            jj_consume_token(OUTPATH);
tempAB.add( a.image, "out" );
path.add(tempJC.build());
            break;
            }
          default:
            jj_la1[32] = jj_gen;
          ...
          jj_consume_token(StartSQBracket);
          c = jj_consume_token(ALPHANUM);
          d = jj_consume_token(GraphElementType);
          jj_consume_token(EndSQBracket);
JsonObjectBuilder tempc = Json.createObjectBuilder(); tempc.add("name", c.image+d.image);path.add(tempc.build());JsonObjectBuilder tempd = Json.createObjectBuilder(); tempd.add("type", d.image);path.add(tempd.build());
          ...
          case INPATH:{
            jj_consume_token(INPATH);
{tempJC.add( c.image, "in" );}
            break;
            }
          case OUTPATH:{
            jj_consume_token(OUTPATH);
tempJC.add( c.image, "out" );
path.add(tempJC.build());
            break;
            }
          default:
          ...
          f = jj_consume_token(GraphElementType);
JsonObjectBuilder tempe = Json.createObjectBuilder(); tempe.add("name", e.image+f.image);path.add(tempe.build()); JsonObjectBuilder tempf = Json.createObjectBuilder(); tempf.add("type", f.image); path.add(tempf.build()) ;
          break;
          }
        case FBRACKETSTART:{
          jj_consume_token(FBRACKETSTART);
          g = jj_consume_token(ALPHANUM);
          h = jj_consume_token(GraphElementType);
          jj_consume_token(FBRACKETEND);
JsonObjectBuilder tempg = Json.createObjectBuilder(); tempg.add("name", g.image+h.image);path.add(tempg.build()); JsonObjectBuilder temph = Json.createObjectBuilder(); temph.add("type", h.image); path.add(temph.build()) ;
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder GraphSelect(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) GraphSelect */
                                                          ASTGraphSelect jjtn000 = new ASTGraphSelect(JJTGRAPHSELECT);
                                                          boolean jjtc000 = true;
                                                          jjtree.openNodeScope(jjtn000);String t; JsonObjectBuilder cypher = Json.createObjectBuilder();JsonObjectBuilder fromCls = Json.createObjectBuilder();JsonArrayBuilder variable  =Json.createArrayBuilder();
    try {
      ...
      Cypher(cypher);
      jj_consume_token(FBRACKETEND);
      t = FromClause(fromCls);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case WHERE:{
JsonObjectBuilder whereC = Json.createObjectBuilder();
        CommonWhereClause(whereC, t);
jObject.add("where",whereC.build());
        break;
        }
      default:
        jj_la1[36] = jj_gen;
...
jjtree.closeNodeScope(jjtn000, true);
  jjtc000 = false;
jObject.add("cypher", cypher.build());jObject.add("src", fromCls.build()); {if ("" != null) return jObject;}
    } catch (Throwable jjte000) {
if (jjtc000) {
    jjtree.clearNodeScope(jjtn000);
    jjtc000 = false;
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder PropertyGraphExpression(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) PropertyGraphExpression */
...
jjtree.closeNodeScope(jjtn000, true);
  jjtc000 = false;
jObject.add("SELECT", tempJB.build()); {if ("" != null) return jObject;}
    } finally {
if (jjtc000) {
     jjtree.closeNodeScope(jjtn000, true);
   }
  ...
  final public JsonObjectBuilder CommonWhereClause(JsonObjectBuilder jObject, String src) throws ParseException {/*@bgen(jjtree) CommonWhereClause */
                                                                            ASTCommonWhereClause jjtn000 = new ASTCommonWhereClause(JJTCOMMONWHERECLAUSE);
                                                                            boolean jjtc000 = true;
                                                                            jjtree.openNodeScope(jjtn000);Token t; JsonObjectBuilder tempJB = Json.createObjectBuilder();
    try {
      jj_consume_token(WHERE);
      tempJB = GetConditionExpression(tempJB, src);
jjtree.closeNodeScope(jjtn000, true);
  jjtc000 = false;
jObject.add("where",tempJB.build()); {if ("" != null) return jObject;}
    } catch (Throwable jjte000) {
if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
if (jjtc000) {
  ...
  final public String FromClause(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) FromClause */
...
jjtree.closeNodeScope(jjtn000, true);
  jjtc000 = false;
jObject.add("from ",tempJB.build()); System.out.println(t.image);{if ("" != null) return t.image;}
    } finally {
if (jjtc000) {
    jjtree.closeNodeScope(jjtn000, true);
  }
  ...
  final public JsonObjectBuilder GetConditionExpression(JsonObjectBuilder l, String src) throws ParseException {/*@bgen(jjtree) GetConditionExpression */
...
if (jjtc000) {
  ...
  final public List GetField(List l) throws ParseException {/*@bgen(jjtree) GetField */
...
if (jjtc000) {
  ...
  final public List GetDictionary(List l) throws ParseException {/*@bgen(jjtree) GetDictionary */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder CreateDataSOURCE(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) CreateDataSOURCE */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder ConnectDataSRC(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) ConnectDataSRC */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder CreatEnvironment(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) CreatEnvironment */
...
if (jjtc000) {
  ...
  final public JsonObjectBuilder function(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) function */
...
if (jjtc000) {
  ...
  final public void UseEnvironment(JsonObjectBuilder jObject) throws ParseException {/*@bgen(jjtree) UseEnvironment */
...
if (jjtc000) {
  ...
  final public void Operand() throws ParseException {/*@bgen(jjtree) Operand */
...
if (jjtc000) {
  ...
  final public void action() throws ParseException {/*@bgen(jjtree) action */
  ...
  private boolean jj_3_10()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8800000,0x8000000,0x0,0x20000,0x0,0x0,0x0,0x40000,0x40000,0x0,0x0,0x0,0x40,0x40,0x800,0x40,0x40,0x20000,0x800040,0x0,0x800000,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x0,0x4000,0x0,0x0,0x4000,0x4000,0x40000000,0x0,0x40,0x200100,0x40,0x80000000,0x40,0x200100,0x40,0x20000,0x20000,0x20000,0x0,0x0,0x40,0x20000,0x40,0x800040,};
   }
